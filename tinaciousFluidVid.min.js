 ...
 *
 */
(function(e){e.fn.extend({tinaciousFluidVid:function(t){var n={id:"56733081",type:"vimeo"};var t=e.extend(n,t);return this.each(function(){var t=e(this);var r='<iframe src="http://player.vimeo.com/video/'+n.id+'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';var i='<iframe src="http://www.youtube.com/embed/'+n.id+'" frameborder="0" allowfullscreen></iframe>';if(n.type=="vimeo"){var s=r}else if(n.type=="youtube"){var s=i}t.append('<div class="responsive-video">'+s+"</div>");e("head").append('<style type="text/css">.responsive-video iframe {position: absolute; top: 0; left: 0; width: 100%; height: 100%;} .responsive-video {position: relative; padding-bottom: 56.25%; height: 0;}</style>')})}})})(jQuery)